...
function AutoHide(el, options) {
  ...
  this.distance = parseInt(options.distance, 10);
...
AutoHide.prototype._startScrollSession = function() {
  ...
  this.elHeight = this.distance || this.el.outerHeight();
...
},{"./domchange":2,"./transition":4,"jquery":5}],4:[function(require,module,exports){
// Test div
