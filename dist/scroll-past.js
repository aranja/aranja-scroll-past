...
ScrollPast.prototype.init = function() {
  ...
  this.viewportEl.on('touchstart.aranja.scrollpast', this._onTouchStart);
  this.viewportEl.on('touchmove.aranja.scrollpast', this._onTouchMove);
  this.viewportEl.on('touchend.aranja.scrollpast', this._onTouchEnd);
};

ScrollPast.prototype._onTouchStart = function() {

};

ScrollPast.prototype._onTouchMove = function() {

};

ScrollPast.prototype._onTouchEnd = function() {
