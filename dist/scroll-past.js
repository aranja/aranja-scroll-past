...
var transformStyle = dasherize(getVendorPropertyName('transform'));

/**
 * Gets a transform transition value with the specified duration and easing.
 */
function getTransition(duration, easing) {
  return transformStyle + ' ' + duration + 'ms ' + easing;
}
