...
ScrollPast.prototype.dispose = function() {
  this.viewportEl.off('.aranja.scrollpast');
...
ScrollPast.prototype._startScrollSession = function() {
  ...
  this._resetScrollRange(this.viewportEl.scrollTop(), this.visibility > 0.5);
};
